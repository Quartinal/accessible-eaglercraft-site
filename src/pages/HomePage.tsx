...
export default function HomePage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-8 minecraft-pattern">
            ...
            <h1 className="text-4xl font-bold mb-6 text-ctp-text minecraft-font tracking-wide text-center text-shadow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl">
                {featuredVersions.map((version) => (
                    ...
                    >
                        ...
                        <div className="mt-4 bg-ctp-green minecraft-button px-6 py-3 rounded-none c-white font-medium minecraft-font">
                            LAUNCH CLIENT
                        </div>
                    </Link>
                ))}
            ...
            <div className="mt-16 p-6 bg-ctp-surface0 rounded-none minecraft-card max-w-3xl">
            ...
            <div className="mt-8 text-center text-ctp-subtext text-sm minecraft-font">
                <p></p>
